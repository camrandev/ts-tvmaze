...
var DEFAULT_IMAGE_URL = "https://store-images.s-microsoft.com/image/apps.65316.13510798887490672.6e1ebb25-96c8-4504-b714-1f7cbca3c5ad.f9514a23-1eb8-4916-a18e-99b1a9817d15?mode=scale&q=90&h=300&w=300";
...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        var response, formattedShows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("".concat(BASE_URL, "/search/shows?q=").concat(term))];
                case 1:
                    response = _a.sent();
                    formattedShows = response.data.map(function (item) {
                        var _a = item.show, id = _a.id, name = _a.name, summary = _a.summary, image = _a.image;
...
function getEpisodesOfShow(id) {
    return __awaiter(this, void 0, void 0, function () {
        var response, formattedEpisodes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    response;
                    formattedEpisodes = response.data.map(function (episode) {
...
function populateEpisodes(formattedEpisodes) {
    $episodesList.empty();
    for (var _i = 0, formattedEpisodes_1 = formattedEpisodes; _i < formattedEpisodes_1.length; _i++) {
        var episode = formattedEpisodes_1[_i];
        var $episode = $("<li>".concat(episode.name, " (").concat(episode.season, ", ").concat(episode.number, ")</li>"));
...
function handleClick(evt) {
    return __awaiter(this, void 0, void 0, function () {
        var $show, showId, episodes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    $show = $(evt.target.closest(".Show"));
